...
namespace WDOOR
{
    public partial class fSub1 : Form
    {
        ...
        private int mnMedusacol, mnMedusarow;
        ...
        private bool fIndirection()
        {
            String sPick = null;
            int nDirection;

            if (mnMedusarow < mnRow)
            {
                sPick = sPick + "1";
            }
            if (mnMedusarow > mnRow)
            ...
            for(int i = 1; i <= sPick.Length; i++)
            {
                nDirection = Convert.ToInt32(sPick.Substring(i - 1,1));
                if (mnRotate == nDirection)
                {
                    return true;
                }
        ...
        private void fMovestone(int nCol,int nRow)
        {
            Random rnd1 = new Random();
        ...
        private void fPeek(int nValue, int nRotate, ref PictureBox _pic2)
        {
            ...
            {
                Name = "pictureBox3",
                Image = Image.FromFile(@"F medusa.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
            PictureBox picture4 = new PictureBox
            {
                Name = "pictureBox4",
                Image = Image.FromFile(@"F stonesintheway.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
        ...
        private void btnNav13_Click(object sender, EventArgs e)
        {
            fNav(3);

        }

        private void btnNav14_Click(object sender, EventArgs e)
        {
            fNav(4);
