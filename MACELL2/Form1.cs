...
namespace MACELL
{
    public partial class Form1 : Form
    {
        ...
        private int mnWin = 0;
        private int mnMoves;
        private int mnCollast, mnRowlast;
        ...
        private void fGEnd()
        {
            MessageBox.Show("GEnd", "You lose");
        }

        private void fEat(int nCol,int nRow,int nCol2,int nRow2)
        {
        ...
        {
            Random rnd1 = new Random();
            int nPlasm = rnd1.Next(4, 15);
            int nBugs = rnd1.Next(1, 5);
            String sTwo = null;
            int nPos = 0;
            int nCol = 0, nRow = 0;
        ...
        private void fPeek(int nValue, int nRotate, ref PictureBox _pic2)
        {
            ...
            {
                Name = "pictureBox3",
                Image = Image.FromFile(@"F plasm.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
            PictureBox picture4 = new PictureBox
            {
                Name = "pictureBox4",
                Image = Image.FromFile(@"F plasm_highlighted.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
